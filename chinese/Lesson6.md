...
很明显，我们可以用矩阵乘法实现一个卷积，但我们不这样做，因为它太慢了。所以，在实践中，我们的库有专门的卷积函数。它们基本上就是做[这个](http://setosa.io/ev/image-kernels/)，也就是 [这个](/lesson6/33.png)

![](./lesson6/33.png)

也就是[这个等式](/lesson6/34.png)

![](./lesson6/34.png)

也就是和[这个矩阵乘法](./lesson6/36.png)相同。
